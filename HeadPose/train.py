...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='DevEv', type=str) #Pose_300W_LP
    parser.add_argument(
        '--data_dir', dest='data_dir', help='Directory path for data.',
        default='/nfs/hpc/cn-gpu5/DevEv/headpose_dataset/', type=str)#BIWI_70_30_train.npz
    parser.add_argument(
        '--filename_list', dest='filename_list',
        help='Path to text file containing relative paths for every example.',
        default='/nfs/hpc/cn-gpu5/DevEv/headpose_dataset/gt_head.txt', type=str) #BIWI_70_30_train.npz #300W_LP/files.txt
    parser.add_argument(
        '--output_string', dest='output_string',
        help='String appended to output snapshots.', default='DevEv', type=str)
    parser.add_argument(
